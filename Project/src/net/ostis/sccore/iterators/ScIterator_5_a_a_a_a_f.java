...
public class ScIterator_5_a_a_a_a_f implements ScIterator {
     ...
     */
    public ScIterator_5_a_a_a_a_f(AbstractGraphDatabase db, List<Long> firstTypes,
        List<Long> secondTypes, List<Long> thirdTypes, List<Long> fourthTypes,
    ...
    /**
     * Returns 5_a_a_a_a_f constraint from next iterator result.
     *
     * @return 5_a_a_a_a_f constraint
     */
