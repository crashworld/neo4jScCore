...
public class ScIterator_5_a_a_f_a_f implements ScIterator {
    ...
    public ScIterator_5_a_a_f_a_f(AbstractGraphDatabase db, List<Long> firstTypes, List<Long> secondTypes,
    ...
    /**
     * Returns 5_a_a_f_a_f constraint from next iterator result.
     *
     * @return 5_a_a_f_a_f constraint
     */
